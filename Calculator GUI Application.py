...
#Geometry Manager is an Interior Designer of your code.
def get_digit(digit):
...
root.resizable(0,0) #To Deny its resizablitiy
...
btn_div=Button(root,text="div",bg="#00a65a",fg="white",width=5,height=2,command=lambda :get_operator("/"))
